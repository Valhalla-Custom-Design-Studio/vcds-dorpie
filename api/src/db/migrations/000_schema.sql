...
-- Base schema for Dorpwag™ — creates all core tables
-- ODIN™ | VCDS™ | Auto-generated to ensure towns table exists before seed migrations
-- This runs first (000_) so all FK references in later migrations succeed
