...
import medicalProfileRouter from './routes/medical_profile';
import adminRouter from './routes/admin';
import adminClaimsRouter from './routes/admin_claims';
...
app.use(`${API}/profile/medical`, medicalProfileRouter);
